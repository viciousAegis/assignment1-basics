...
def run_linear(
    ...
    """
    lin = Linear(in_feat=d_in, out_feat=d_out)
    lin.load_state_dict(state_dict={"weights": weights})
...
def run_embedding(
    ...
    emb.load_state_dict(state_dict={"weights": weights})
...
def run_rmsnorm(
    ...
    rms_norm.load_state_dict(state_dict={"gain": weights})
